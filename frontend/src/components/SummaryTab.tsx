...
${summary}`;
  ...
  return (
    <div className="flex flex-col h-full min-h-0 animate-fadeIn">
      {/* Scrollable markdown summary */}
      <div
        className="flex-1 overflow-y-auto rounded-2xl border border-muted bg-background text-foreground p-7 prose prose-invert max-w-none shadow-lg"
        style={{
